...
export interface NWLVaultErrorReporterInterface extends utils.Interface {
  functions: {};
...
export interface NWLVaultErrorReporter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NWLVaultErrorReporterInterface;
