...
export interface NWLVaultAdminStorageInterface extends utils.Interface {
  functions: {
...
export interface NWLVaultAdminStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NWLVaultAdminStorageInterface;
