...
export interface NWLVaultStorageV1Interface extends utils.Interface {
  functions: {
...
export interface NWLVaultStorageV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NWLVaultStorageV1Interface;
