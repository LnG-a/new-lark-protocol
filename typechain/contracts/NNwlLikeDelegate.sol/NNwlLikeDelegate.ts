...
export interface NNwlLikeDelegateInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "_delegateNwlLikeTo",
  ...
  encodeFunctionData(functionFragment: "isNToken", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "isNToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "liquidateBorrow",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "MintBehalf(address,address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "MintBehalf"): EventFragment;
...
export interface MintBehalfEventObject {
  payer: string;
  receiver: string;
  mintAmount: BigNumber;
  mintTokens: BigNumber;
}
export type MintBehalfEvent = TypedEvent<
  [string, string, BigNumber, BigNumber],
  MintBehalfEventObject
>;

export type MintBehalfEventFilter = TypedEventFilter<MintBehalfEvent>;
...
export interface NNwlLikeDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NNwlLikeDelegateInterface;
  ...
  functions: {
    ...
    _delegateNwlLikeTo(
      nwlLikeDelegatee: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    isNToken(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isNToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isNToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
