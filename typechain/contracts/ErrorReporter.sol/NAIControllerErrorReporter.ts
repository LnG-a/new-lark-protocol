...
export interface NAIControllerErrorReporterInterface extends utils.Interface {
  functions: {};
...
export interface NAIControllerErrorReporter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NAIControllerErrorReporterInterface;
