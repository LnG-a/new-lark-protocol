...
export interface ComptrollerV8StorageInterface extends utils.Interface {
  functions: {
...
export interface ComptrollerV8Storage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComptrollerV8StorageInterface;
