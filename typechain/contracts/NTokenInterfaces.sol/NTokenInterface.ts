...
export interface NTokenInterfaceInterface extends utils.Interface {
  functions: {
...
export interface NTokenInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NTokenInterfaceInterface;
