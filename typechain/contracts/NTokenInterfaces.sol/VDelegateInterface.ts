...
export interface VDelegateInterfaceInterface extends utils.Interface {
  functions: {
...
export interface VDelegateInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VDelegateInterfaceInterface;
