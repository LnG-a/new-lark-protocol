...
export interface NAIControllerStorageG2Interface extends utils.Interface {
  functions: {
...
export interface NAIControllerStorageG2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NAIControllerStorageG2Interface;
