...
export interface ComptrollerInterfaceG2Interface extends utils.Interface {
  functions: {
...
export interface ComptrollerInterfaceG2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComptrollerInterfaceG2Interface;
