...
export interface NarwhalChainlinkOracleV2Interface extends utils.Interface {
  functions: {
    ...
    "setMultipleDirectPrice(address[],uint256[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setMultipleDirectPrice",
    values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]
  ): string;
  encodeFunctionData(
...
export interface NarwhalChainlinkOracleV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NarwhalChainlinkOracleV2Interface;
