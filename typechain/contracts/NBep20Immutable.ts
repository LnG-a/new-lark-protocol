...
export interface NBep20ImmutableInterface extends utils.Interface {
  functions: {
...
export interface NBep20Immutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NBep20ImmutableInterface;
