...
export interface VRTVaultAdminStorageInterface extends utils.Interface {
  functions: {
...
export interface VRTVaultAdminStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VRTVaultAdminStorageInterface;
