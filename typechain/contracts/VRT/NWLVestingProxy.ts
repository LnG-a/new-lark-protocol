...
export interface NWLVestingProxyInterface extends utils.Interface {
  functions: {
...
export interface NWLVestingProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NWLVestingProxyInterface;
