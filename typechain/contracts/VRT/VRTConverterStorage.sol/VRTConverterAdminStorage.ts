...
export interface VRTConverterAdminStorageInterface extends utils.Interface {
  functions: {
...
export interface VRTConverterAdminStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VRTConverterAdminStorageInterface;
