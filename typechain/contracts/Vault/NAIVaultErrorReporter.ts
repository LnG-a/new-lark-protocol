...
export interface NAIVaultErrorReporterInterface extends utils.Interface {
  functions: {};
...
export interface NAIVaultErrorReporter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NAIVaultErrorReporterInterface;
